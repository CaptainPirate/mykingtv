...
public class HomeFragment extends BaseFragment<ICategoryView, CategoryPresenter> implements ICategoryView {
    ...
    private static String TAG = "hss HomeFragment";
    ...
    public void initUI() {
        ...
        //listData.add(RecommendFragment.newInstance());//加载数据
        //listTitle.add(getText(R.string.tab_all));
       // listData.add(LiveListFragment.newInstance(null));//加载数据
    ...
    @Override
    public void initData(){//在父类BaseFragment里面调用
        Log.d(TAG,"initData");
//        getPresenter().getAllCategoriesByDB();
    ...
    public void onGetLiveCategory(List<LiveCategory> list) {
        Log.d(TAG,"onGetLiveCategory");
        if(list!=null){
            Log.d(TAG,"onGetLiveCategory list!=null");
